...
const Navbar = () => {
    ...
    return (<div className='text-white flex justify-between items-center h-24 max-w-[1240px] w-screen mx-auto px-4'>
        ...
        <div onClick={handleNav} className='md:hidden '>
            {!denis ? <AiOutlineClose size={30}/> : <AiOutlineMenu size={30}/>}

        </div>
        <div
            className={!denis ? 'fixed left-0 top-0 w-[80%] h-full border-r border-r-white/50 bg-[#000300] z-50 ease-in-out duration-700' : 'fixed left-[-100%]'}>
